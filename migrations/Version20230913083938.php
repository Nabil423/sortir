 ...
 */
final class Version20230913083938 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie ADD lieu_id INT NOT NULL, ADD organisateur_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie DROP lieu_id, DROP organisateur_id');
    }
}
